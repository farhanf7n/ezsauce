...
export default function Card({ item }) {
  ...
  return (
    <div
      ref={cardRef}
      className="group relative bg-cosmic-latte dark:bg-[#1F1F1F] border border-1 border-medium-gray rounded-[8px] cursor-pointer hover:border-dashed dark:hover:border-[#FFC70F] dark:hover:shadow-drop-dark transition-shadow duration-300 animate-card"
