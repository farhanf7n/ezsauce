  ...
  return (
    <div className="w-full mx-auto max-w-[1160px]">
      <motion.div
        ...
        custom={0}
        className="mx-4 relative top-4 px-4 py-2 flex items-center justify-between  transition-all duration-300 z-[9999] bg-glass-cosmic-latte/90 dark:bg-[rgba(40,40,40,0.97)] backdrop-blur-3xl border border-white/20 dark:border-white/10 rounded-[8px]"
      >
