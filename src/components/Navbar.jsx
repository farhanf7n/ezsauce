...
export default function Navbar() {
  ...
  return isScrolled ? (
    <motion.div
      ...
      custom={0}
      className="w-full lg:w-[720px] px-5 mt-2 fixed top-2 left-1/2 -translate-x-1/2 -translate-y-0 opacity-100 z-[9999] transition-all duration-300 origin-top animate-slideDown"
    >
